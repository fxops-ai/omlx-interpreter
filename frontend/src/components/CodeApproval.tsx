    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 13, color: '#e8e8e8', letterSpacing: '0.04em' }}>
        ...
        <div style={{ flex: 1, padding: 16, overflowY: 'auto', background: '#0d0d0d' }}>
          <div style={{ fontSize: 11, color: '#22c55e', marginBottom: 8, letterSpacing: '0.06em' }}>
            // {language}
          </div>
          <pre style={{ margin: 0, fontSize: 12, color: '#e8e8e8', lineHeight: 1.6, whiteSpace: 'pre-wrap' }}>
            {code}
          </pre>
        </div>
